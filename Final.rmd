...
colPerc(table1)
```
According to the chart we can see that the first treatment was a lot more subject on the straight category they took more treatment than the gay category. As there is a significant difference as the straight category is around 91% while the gay category, only 8% took the treatment. On the second treatment both subgroups took about the same, they have both around 50%. 
